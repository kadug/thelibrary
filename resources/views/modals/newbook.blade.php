...
<div class="modal fade" id="NewBookModal" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{route('AddNewBook')}}" method="POST" id="RegisterNewBook">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" id="SaveBook">Save Book</button>
      </div>
    </div>
  </div>
</div>